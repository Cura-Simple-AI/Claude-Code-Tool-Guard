...
| `SLEEP_TG_FORCE=1` | unset | Emergency bypass — skip all checks, run real sleep |
...
# Force override always succeeds
SLEEP_TG_FORCE=1 SLEEP_TG_REAL_BIN=/bin/true python3 \
  scripts/tool-guard/sleep/wrapper.py 999h
echo $?  # → 0
```
